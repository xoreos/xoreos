...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec2<A, Q> const & _a, B _b, C c) :
		x(static_cast<T>(_a.x)),
	...
	template <typename T, precision P>
	template <typename A, typename B, typename C, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec2<A, Q> const & _a, tvec1<B, Q> const & _b, tvec1<C, Q> const & c) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_a.y)),
	...
	template <typename T, precision P>
	template <typename A, typename B, typename C, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec1<A, Q> const & _a, tvec2<B, Q> const & _b, tvec1<C, Q> const & c) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_b.x)),
	...
	template <typename T, precision P>
	template <typename A, typename B, typename C, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec1<A, Q> const & _a, tvec1<B, Q> const & _b, tvec2<C, Q> const & c) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_b.x)),
		z(static_cast<T>(c.x)),
		w(static_cast<T>(c.y))
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec3<A, Q> const & _a, B _b) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_a.y)),
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec3<A, Q> const & _a, tvec1<B, Q> const & _b) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_a.y)),
		z(static_cast<T>(_a.z)),
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(A _a, tvec3<B, Q> const & _b) :
		x(static_cast<T>(_a)),
		y(static_cast<T>(_b.x)),
		z(static_cast<T>(_b.y)),
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec1<A, Q> const & _a, tvec3<B, Q> const & _b) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_b.x)),
		z(static_cast<T>(_b.y)),
		w(static_cast<T>(_b.z))
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec4<T, P>::tvec4(tvec2<A, Q> const & _a, tvec2<B, Q> const & _b) :
		x(static_cast<T>(_a.x)),
		y(static_cast<T>(_a.y)),
		z(static_cast<T>(_b.x)),
