...
class ERFWriter {
public:
	/** Create an ERF writer by writing the header to the stream and reserve fileCount places in the key and resource
	 *  table.
	 *
	 ...
	 */
	ERFWriter(uint32 id, uint32 fileCount, Common::SeekableWriteStream &stream, ERFVersion version = kERFVersion10,
