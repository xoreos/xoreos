...
AACStream::AACStream(Common::SeekableReadStream *stream, bool disposeStream,
		Common::SeekableReadStream *extraData, bool disposeExtraData) {
...
// Factory function
AudioStream *makeAACStream(Common::SeekableReadStream *stream, bool disposeStream,
		Common::SeekableReadStream *extraData, bool disposeExtraData) {
