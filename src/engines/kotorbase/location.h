...
/** @file
 *  A location within an area in KotOR games.
 */

#ifndef ENGINES_KOTORBASE_LOCATION_H
#define ENGINES_KOTORBASE_LOCATION_H
...
public:
	...
	Location(const Location &x) = default;
...
#endif // ENGINES_KOTORBASE_LOCATION_H
