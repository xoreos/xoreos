...
#ifndef ENGINES_KOTOR_ACTIONEXECUTOR_H
#define ENGINES_KOTOR_ACTIONEXECUTOR_H
...
private:
	/** Move the creature towards a point. Returns true if the point
	 *  is within the specified range, false otherwise.
	 */
...
#endif // ENGINES_KOTOR_ACTIONEXECUTOR_H
