...
/** @file engines/nwn/menu/partybar.cpp
...
Partybar::Partybar() {
	...
	_portrait = new NWNQuadWidget(*this, "Portrait", "gui_po_nwnlogo_l",
	                              0.0, 0.0, 64.0, 100.0,
	...
	_health = new NWNQuadWidget(*this, "Healthbar", "", 0.0, 0.0, 6.0, 100.0);
