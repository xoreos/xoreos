...
#include "src/engines/dragonage/script/function_tables.h"
...
Aurora::NWScript::Object *Functions::getParamObject(const Aurora::NWScript::FunctionContext &ctx, size_t n) {
	DragonAge::Object *object = DragonAge::ObjectContainer::toObject(ctx.getParams()[n].getObject());
...
void Functions::jumpTo(DragonAge::Object *object, float x, float y, float z) {
