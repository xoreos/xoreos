...
#ifndef ENGINES_DRAGONAGE_MODELLOADER_H
#define ENGINES_DRAGONAGE_MODELLOADER_H
...
class DragonAgeModelLoader : public ModelLoader {
public:
...
#endif // ENGINES_DRAGONAGE_MODELLOADER_H
