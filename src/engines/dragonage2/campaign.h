...
#ifndef ENGINES_DRAGONAGE2_CAMPAIGN_H
#define ENGINES_DRAGONAGE2_CAMPAIGN_H
...
private:
	...
	struct RIMNode {
		...
		Common::UString rimFXE;      ///< The RIM file containing facial animations (FXE).
...
#endif // ENGINES_DRAGONAGE2_CAMPAIGN_H
