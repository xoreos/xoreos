...
#ifndef ENGINES_DRAGONAGE2_OBJECTCONTAINER_H
#define ENGINES_DRAGONAGE2_OBJECTCONTAINER_H
...
private:
	typedef std::list<DragonAge2::Object *> ObjectList;
...
#endif // ENGINES_DRAGONAGE2_OBJECTCONTAINER_H
