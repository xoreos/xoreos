...
#ifndef ENGINES_KOTOR2_GUI_CHARGEN_CHARGENPORTRAIT_H
#define ENGINES_KOTOR2_GUI_CHARGEN_CHARGENPORTRAIT_H
...
#endif // ENGINES_KOTOR2_GUI_CHARGEN_CHARGENPORTRAIT_H
