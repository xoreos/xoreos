...
/** @file
 *  Trigger in a Star Wars: Knights of the Old Republic II: The Sith
 *  Lords area.
 */

#ifndef ENGINES_KOTOR2_TRIGGER_H
#define ENGINES_KOTOR2_TRIGGER_H
...
#endif // ENGINES_KOTOR2_TRIGGER_H
