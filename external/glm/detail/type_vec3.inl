...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(T a, T _b, T c)
		: x(a), y(_b), z(c)
	{}
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(A a, B _b, C c) :
		x(static_cast<T>(a)),
		y(static_cast<T>(_b)),
		z(static_cast<T>(c))
	{}
	...
	template <typename T, precision P>
	template <typename A, typename B, typename C>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(tvec1<A, P> const & a, tvec1<B, P> const & _b, tvec1<C, P> const & c) :
		x(static_cast<T>(a)),
		y(static_cast<T>(_b)),
		z(static_cast<T>(c))
	{}
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(tvec2<A, Q> const & a, B _b) :
		x(static_cast<T>(a.x)),
		y(static_cast<T>(a.y)),
		z(static_cast<T>(_b))
	{}
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(tvec2<A, Q> const & a, tvec1<B, Q> const & _b) :
		x(static_cast<T>(a.x)),
		y(static_cast<T>(a.y)),
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(A a, tvec2<B, Q> const & _b) :
		x(static_cast<T>(a)),
	...
	template <typename T, precision P>
	template <typename A, typename B, precision Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR_CTOR tvec3<T, P>::tvec3(tvec1<A, Q> const & a, tvec2<B, Q> const & _b) :
		x(static_cast<T>(a.x)),
		y(static_cast<T>(_b.x)),
		z(static_cast<T>(_b.y))
	{}
