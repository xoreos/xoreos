...
TEST(SerializationStream, readAndWriteData) {
	Common::MemoryWriteStreamDynamic writeStream(true);

	Common::SerializationWriteStream serialWriteStream(writeStream);

	uint64 test64 = 0x1122334455667788;
	serialWriteStream.readOrWriteUint64LE(0x1122334455667788);
	serialWriteStream.readOrWriteUint64LE(test64);
	serialWriteStream.readOrWriteUint64BE(0x1122334455667788);
	...
	EXPECT_NO_THROW(serialReadStream.readOrWriteUint64LE(0x1122334455667788));
	serialReadStream.readOrWriteUint64LE(test64);
	EXPECT_EQ(test64, 0x1122334455667788);
	EXPECT_NO_THROW(serialReadStream.readOrWriteUint64BE(0x1122334455667788));
